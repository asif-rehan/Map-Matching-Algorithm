...
def list_cand_point_constructor(shapely_buffer, shapely_point, 
    ...
    a polyliine in the fiona/shapely/OGR
    ...
    with fiona.open(path_to_road_network_shapefile) as shp:
        ...
        while rec:
            ...
            if line.intersects(shapely_buffer) == True:
                ...
                emission_prob = scipy.stats.norm(gps_mean, gps_std_dev).pdf(distance)
                candidate_point=candidate_point_object(
